...
public class TenantRequestBean implements Serializable {
     ...
     * 等级 0=测试；1=普通；2=高级
     */
    @ApiModelProperty(value = "租户等级", required = true, position = 4)
    @NotNull(message = "租户等级不能为空")
    private Integer tenantLevel;

    /**
     * 租户来源
     */
    @ApiModelProperty(value = "租户来源", required = true, position = 5)
     ...
     * 管理帐号。
     */
    @ApiModelProperty(value = "租户的管理帐号", required = true, position = 6)
     ...
     * 租户角色。
     */
    @ApiModelProperty(value = "租户角色", required = true, position = 7)
    @NotEmpty(message = "租户角色不能为空")
