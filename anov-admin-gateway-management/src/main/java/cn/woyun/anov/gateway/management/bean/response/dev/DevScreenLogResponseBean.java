...
@ToString
@EqualsAndHashCode
@ApiModel(value = "大屏日志响应数据类")
public class DevScreenLogResponseBean {
     ...
     * 日志模块
     */
    @ApiModelProperty(value = "日志模块", position = 3)
    private String logModule;

    /**
     * 日志描述
     */
    @ApiModelProperty(value = "日志描述", position = 4)
     ...
     * 大屏标识
     */
    @ApiModelProperty(value = "大屏标识", position = 6)
    private String screenKey;

    /**
     * 大屏等级
     */
    @ApiModelProperty(value = "大屏等级", position = 7)
    private String screenLevel;

    /**
     * 大屏环境
     */
    @ApiModelProperty(value = "大屏环境", position = 8)
    private String screenEnv;

    /**
     * 大屏开发目录
     */
    @ApiModelProperty(value = "大屏开发目录", position = 9)
    private String screenDir;

    /**
     * 大屏框架版本
     */
    @ApiModelProperty(value = "大屏框架版本", position = 10)
    private String screenFrameworkVersion;

    /**
     * 大屏芯片版本
     */
    @ApiModelProperty(value = "大屏芯片版本", position = 11)
    private String screenCoreVersion;

    /**
     * 大屏是否有子客户端
     */
    @ApiModelProperty(value = "大屏是否有子客户端", position = 12)
    private Boolean screenHasChildren;

    /**
     * 大屏是否展开
     */
    @ApiModelProperty(value = "大屏是否展开", position = 13)
    private Boolean screenLeafed;

    /**
     * 客户端唯一标识 浏览器的唯一性标识
     */
    @ApiModelProperty(value = "客户端唯一标识", position = 14)
    private String clientCode;

    /**
     * 客户端的远程终端标识
     */
    @ApiModelProperty(value = "客户端的远程终端标识", position = 15)
    private String clientRemoteCode;

    /**
     * 客户端类型 PC或者APP等
     */
    @ApiModelProperty(value = "客户端类型", position = 16)
     ...
     * 客户端分辨率
     */
    @ApiModelProperty(value = "客户端分辨率", position = 18)
    private String clientResoliving;

    /**
     * 客户端语言
     */
    @ApiModelProperty(value = "客户端语言", position = 19)
